...
//     // Only trigger the scroll if the location contains a hash
//     if (location.hash) {
//       scrollToHash();
//     }
//   }, [location]);
...
//     <CarouselItemContainer key={experience.id} id={`experience${experience.id}`}>
//       <GroupContainer>
//         <PositionContainer>
...
//             <TimelineItem key={experience.id} id={`experience${experience.id}`}>
